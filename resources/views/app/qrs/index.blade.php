...
<main class="-mt-24 pb-8">
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div class="mb-10 rounded-lg bg-white overflow-hidden shadow">
            <h2 class="sr-only" id="profile-overview-title">@lang('crud.qrs.index_title')</h2>
            <div class="bg-white p-6">
              <div class="sm:flex sm:items-center sm:justify-between">
                <div class="sm:flex sm:space-x-5">
                  <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                    <p class="text-sm font-medium text-gray-600">TCL Tankers</p>
                    <p class="text-xl font-bold text-gray-900 sm:text-2xl">@lang('crud.qrs.index_title')</p>
                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="mb-4 bg-transparent divide-y divide-gray-200 w-full">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-900 uppercase tracking-wider">
                                                @lang('crud.qrs.inputs.tankers_id')
                                            </th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-900 uppercase tracking-wider">
                                                @lang('crud.qrs.inputs.label')
                                            </th>
                                    ...
                                    <tbody>
                                        @forelse($qrs as $qr)
                                        <tr class="bg-white hover:bg-gray-50 items-stretch">
                                            ...
                                            <td class="px-6 py-4 text-right text-sm font-medium">
                                                <a href="{{ route('qrs.edit', $qr) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                            </td>
                                        </tr>
                                        @empty
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td class="pt-10 px-10" colspan="3">
                                                {!! $qrs->render() !!}
                                            </td>
                                        </tr>
                                    </tfoot>
