            ...
            <main class="-mt-24 pb-8">
                ...
                <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                    <div class="mb-10 rounded-lg bg-white overflow-hidden shadow">
                        <h2 class="sr-only" id="profile-overview-title">Rigid On/Off Hire Checklist</h2>
                        <div class="bg-white p-6">
                          <div class="sm:flex sm:items-center sm:justify-between">
                            <div class="sm:flex sm:space-x-5">
                              <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                                <p class="text-sm font-medium text-gray-600">TCL Tankers</p>
                                <p class="text-xl font-bold text-gray-900 sm:text-2xl">Rigid On/Off Hire Checklist</p>
                            ...
                            <div class="shadow sm:rounded-md sm:overflow-hidden">
                                ...
                                <div class="grid grid-cols-6 gap-6 pb-6">
                                    ...
                                    <div class="mt-6 col-span-3 sm:col-span-3">
                                        ...
                                        <label for="fleet-num" class="block text-sm font-medium text-gray-700">Last Known Product</label>
                                    ...
                                    <div class="mt-6 col-span-3 sm:col-span-3">
                                        ...
                                        <label for="fleet-num" class="block text-sm font-medium text-gray-700">Mileage</label>
                                        <input type="text" name="fleet-num" id="fleet-num" autocomplete="" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    ...
                                    <div class="mt-6 col-span-6 sm:col-span-6">
                                      <fieldset>
                                        ...
                                        <div class="mt-4 space-y-4">
                                          <div class="flex items-center">
                                            <input id="Good" name="push_notifications" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                            <label for="Good" class="ml-3 block text-sm font-medium text-gray-700">
                                              Good
                                            </label>
                                          </div>
                                          <div class="flex items-center">
                                            <input id="Average" name="push_notifications" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                            <label for="Average" class="ml-3 block text-sm font-medium text-gray-700">
                                              Average
                                            </label>
                                          </div>
                                          <div class="flex items-center">
                                            <input id="Poor" name="push_notifications" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                            <label for="Poor" class="ml-3 block text-sm font-medium text-gray-700">
                                              Poor
                                            </label>
                                          </div>
                                          <div class="flex items-center">
                                            <input id="unserviceable" name="push_notifications" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        ...
                                        <div class="mt-1 bg-white rounded-md shadow-sm -space-y-px">
                                          ...
                                          <div class="flex -space-x-px">
                                            ...
                                            <div class="flex-1 min-w-0">
                                              <input type="text" name="card-cvc" id="card-cvc" class="relative block w-full rounded-none bg-gray-100 focus:z-10 sm:text-sm border-gray-300" disabled>
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <input type="text" name="card-cvc" id="card-cvc" class="relative block w-full rounded-none bg-gray-100 focus:z-10 sm:text-sm border-gray-300" disabled>
                                            </div>
